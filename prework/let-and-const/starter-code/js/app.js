...
function displayPics(){
  ...
  // by declaring rando within the code block of the while loop, it was of a local scope. The console.log statement was outside of the locality of the variable.
  console.log(viewed);
